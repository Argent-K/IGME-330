...
class AppHeader extends HTMLElement{
  ...
  connectedCallback(){
    ...
    this.shadowRoot.querySelector("#btn-hello").addEventListener("click", () => {
      console.log(`clicked ${this.tagName}`);
      this.callback(this.greeting);
    });
    // this.shadowRoot.querySelector("#btn-hello").addEventListener("click", function(){
    //   console.log(`clicked ${this.tagName}`);
    // });
    this.shadowRoot.querySelector("#btn-goodbye").addEventListener("click", () => {
      this.callback(`${this.farewell} and a special bonus number ${this.specialNumber}`);
    });
  ...
  disconnectedCallback(){
    ...
    this.shadowRoot.querySelector("#btn-hello").addEventListener("click", null);
    this.shadowRoot.querySelector("#btn-goodbye").addEventListener("click", null);
  }
